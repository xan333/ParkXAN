...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор="c0008369-08bb-459a-897f-955a627796f0";
	Обработчик.Комментарий=НСтр("ru = 'Перенос файлов фото спр.Аттракционы'");
	...
	//Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения     = "Отложенно";		
	Обработчик.Идентификатор="d138137f-afb6-4928-88ad-34ae1a39b876";
	Обработчик.Комментарий=НСтр("ru = 'Перенос телефонов из реквизита в ТЧ Контактная информация'");
